...
public class Flight implements Filter, Comparable<Flight> {
	public int fid;
	...
	public static final String INFO_SEARCH = "SELECT day_of_month, " +
			"carrier_id, flight_num, origin_city, dest_city, actual_time, " +
			"capacity, price FROM Flights WHERE fid = ?";
	private PreparedStatement infoFind;
